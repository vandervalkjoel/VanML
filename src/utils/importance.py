...
def train_and_evaluate():
    ...
    # Print the importance of 'Number_of_Referrals'
    number_of_referrals_importance = feature_importance_df.loc[feature_importance_df['Feature'] == 'Number_of_Referrals', 'Importance'].iloc[0]
    print(f"Importance of 'Number_of_Referrals': {number_of_referrals_importance}")
